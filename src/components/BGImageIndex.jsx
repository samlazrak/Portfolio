...
const BGImageIndex = styled.div`
  width: 100%;
  .gatsby-image-wrapper {
    position: static !important;
    filter: grayscale(100%);
    > div {
      padding-bottom: ${(props) => (props.single ? '30vw' : '70vw')} !important;
      @media (max-width: ${(props) => props.theme.breakpoints.m}),
        (max-device-width: ${(props) => props.theme.breakpoints.m}) {
        padding-bottom: ${(props) =>
          props.single ? '40vw' : '60vw'};!important;
      }
  ...
  &:after {
    ...
    background: ${({
      ...
      linear-gradient(to right, ${shade} 100%, ${theme.bg_color} 100%)`};
    content: '';
    height: 100%;
    left: 0;
    position: absolute;
